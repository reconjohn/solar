---
title: "Clean Technology Distribution"
author: "Yohan Min"
...
* Verifying social equity due to the uneven distribution of clean energy technologies
* Verifying program impact on clean energy technology diffusion 
* Verifying Peer effect on clean energy technology diffusion 
* Identifying communities with high diffusion prediction
...
* Climate change has caused clean energy policies
...
* Disscussion on the most significant factors on the clean energy technology diffusion
...
* Current uneven distribution of clean energy technologies presenting social equity issue
* The most significant factors to the uneven distribution were identified
* Spatial autocorrelation were addressed 
* Socio-demographic data from Sensus could be used as predictors for other regions
* Sensitive regions identified for policy makers to address social equity for effective and even distribution

# 2. Program Impact/ Peer Effect on Diffusion (PV, and EV)

## Motivation 

* Differnt diffusion trend by region
* Local community based program impact on diffusion 
...
* A certain program may affect the diffusion trend different among regions 
...
* The identified local community based program influencing the diffusion trend significantly
* Sptio-temporal peer effect is significant for diffusion
...
* The most significant factor to the diffusion was identified (local community based program and peer effect)
* Diffusion model were suggsted on PV and EV
* New finding on importance of community involvement and peer effect on diffusion 
* Policy makers can increase diffusion while saving the acquisition cost 


# 3. Identifying Regions with Higher Diffusion Prediction 

## Motivation 

* Different diffusion pattern between PV and EV and by region
...
* A certain region needs more attention due to addition of variable clean energy technologies
...
* The most expected significant region was identified due to higher diffusion rate
* Prediction model was suggested to estimate the future impact of addtion of PV and EV
* Policy makers and utilities referring to this result to plan their investment on systems of distribution and scalable renewable energy
